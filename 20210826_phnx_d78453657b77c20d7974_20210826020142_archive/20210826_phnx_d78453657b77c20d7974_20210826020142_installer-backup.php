...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210826_phnx_d78453657b77c20d7974_20210826020142_archive.zip';
    const ARCHIVE_SIZE       = '214376439';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = 'd784536-26020142';
    const SECONDARY_PACKAGE_HASH = '3991d55-26020142';
    const VERSION            = '4.0.4';
